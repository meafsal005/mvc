...
@ComponentScan(basePackages="com.contacts.dao")
...
public class ApplicationContextConfig {
	...
	public LocalSessionFactoryBean sessionFactory(DataSource dataSource) throws IOException {
		...
		localSessionFactoryBean.setPackagesToScan("com.contacts.model");
		
		Properties properties = new Properties();
		properties.setProperty("hibernate.hbm2ddl.auto", "create-drop"); //create, update, validate, none
